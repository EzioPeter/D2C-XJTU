...
#TODO: thigh range
def update_source_env_thigh_range(variety_degree, env_name):
    old_xml_name = parse_xml_name(env_name)
    # create new xml
...
#TODO: short thigh
def update_source_env_short_thigh(variety_degree, env_name):
    old_xml_name = parse_xml_name(env_name)
    # create new xml
...
#TODO: torso length
def update_source_env_torso_length(variety_degree, env_name):
    old_xml_name = parse_xml_name(env_name)
    # create new xml
